        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <Link 
              ...
              className="w-full sm:w-auto bg-gradient-modual text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 text-center"
            >
              {t('home.startNow')}
            </Link>
            <Link 
              href="https://wa.me/212720741951" 
              target="_blank"
