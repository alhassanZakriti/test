        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <Link 
              ...
              className="border-2 border-green-500 dark:border-green-400 text-green-600 dark:text-green-400 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-green-50 dark:hover:bg-green-900/20 hover:border-green-600 dark:hover:border-green-300 transition-all duration-300 flex items-center justify-center gap-2"
            >
              ...
              {t('home.contactWhatsApp') || 'WhatsApp'}
            </Link>
          </motion.div>
